...
const iamge1 = document.getElementById('image1');
...
function toggleDarkLightMode() {
    nav.style.backgroundColor = theme === DARK_THEME ? 'rgb(46 52 64 / 50%)' : 'rgb(236 239 244 / 50%)';
    textBox1.style.backgroundColor = theme === DARK_THEME ? 'rgb(236 239 244 / 50%)' : 'rgb(46 52 64 / 50%)';
    textBox2.style.backgroundColor = theme === DARK_THEME ? 'rgb(236 239 244 / 50%)' : 'rgb(46 52 64 / 50%)';
    ...
    iamge1.src = `img/undraw_proud_coder_${theme}.svg`;
    iamge2.src = `img/undraw_feeling_proud_${theme}.svg`;
    iamge3.src = `img/undraw_conceptual_idea_${theme}.svg`;
    image4.src = `img/undraw_team_spirit_${theme}.svg`;
}
...
// Check Loacal Storage For Theme
